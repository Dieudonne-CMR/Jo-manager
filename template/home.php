...
<body>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    foreach (select_table_where("produicts_all", "mat_produit", $mat_produit) as $key => $produit):
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><button type="button" class="btn small-frame btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".exampleModalFullscreen">
                                                                    <img class="img-fluid" src="<?php echo $image_produit . $produit->Img1; ?>" alt="imge" onclick="Modal(<?php echo $key; ?>)"></button>
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="exampleModalFullscreenLabel"></h5>
                                                        ...
                                                        <div class="row">
                                                                        ...
                                                                        <div class="col-3">
                                                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                                                <a class="nav-link active" id="product-1-tab" data-bs-toggle="pill" href="#product-1" role="tab">
                                                                                    <img src=" " alt="imge" class="img-fluid mx-auto d-block tab-img rounded" id="img-1">
                                                                                </a>
                                                                                <a class="nav-link" id="product-2-tab" data-bs-toggle="pill" href="#product-2" role="tab">
                                                                                    <img src=" " alt="imge" class="img-fluid mx-auto d-block tab-img rounded" id="img-2">
                                                                                </a>
                                                                                <a class="nav-link" id="product-3-tab" data-bs-toggle="pill" href="#product-3" role="tab">
                                                                                    <img src=" " alt="imge" class="img-fluid mx-auto d-block tab-img rounded" id="img-3">
                                                                                </a>
                                                                                <a class="nav-link" id="product-4-tab" data-bs-toggle="pill" href="#product-4" role="tab">
                                                                                    <img src=" " alt="imge" class="img-fluid mx-auto d-block tab-img rounded" id="img-4">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                                <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                                                                                    <div class="product-img">
                                                                                        <img src=" " alt="imge" class="img-fluid mx-auto d-block" data-zoom="assets/images/product/img-1.png" id="img--1">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="tab-pane fade" id="product-2" role="tabpanel">
                                                                                    <div class="product-img">
                                                                                        <img src=" " alt="imge" class="img-fluid mx-auto d-block" id="img--2">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="tab-pane fade" id="product-3" role="tabpanel">
                                                                                    <div class="product-img">
                                                                                        <img src=" " alt="imge" class="img-fluid mx-auto d-block" id="img--3">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="tab-pane fade" id="product-4" role="tabpanel">
                                                                                    <div class="product-img">
                                                                                        <img src=" " alt="imge" class="img-fluid mx-auto d-block" id="img--4">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-xl-7">
                                                                <div class="mt-4 mt-xl-3">
                                                                    <h5 class="mt-1 mb-3" id="gamme"></h5>
                                                                    ...
                                                                    <h5 class="mt-2" id="prix"><del class="text-muted me-2"></del> <span class="text-danger font-size-12 ms-2"></span></h5>
                                                                    ...
                                                                    <div class="mt-4">
                                                                        ...
                                                                        <div class="mt-4">
                                                                            <p class="text-muted mb-2" id="description-modal"><i class="mdi mdi-check-bold text-success me-2"></i></p>
                                                                        </div>
                                                                    </div>
    ...
    <script>
        var produits = <?php echo json_encode(select_table_where("produicts_all", "mat_produit", $mat_produit)); ?>;
        var image_produit = '<?php echo ($image_produit); ?>';

        function Modal(key) {
            var produit = produits[key];
            document.getElementById('exampleModalFullscreenLabel').innerText = produit.nom_produit;
            document.getElementById('img-1').src = image_produit + produit.Img1;
            document.getElementById('img-2').src = image_produit + produit.Img2;
            document.getElementById('img-3').src = image_produit + produit.Img3;
            document.getElementById('img-4').src = image_produit + produit.Img4;
            document.getElementById('img--1').src = image_produit + produit.Img1;
            document.getElementById('img--2').src = image_produit + produit.Img2;
            document.getElementById('img--3').src = image_produit + produit.Img3;
            document.getElementById('img--4').src = image_produit + produit.Img4;
            document.getElementById('gamme').innerText = "Gamme: " + produit.nom_gamme + ", Dimensions: " + produit.dimensions + ", Epaisseur: " + produit.epaisseur;
            document.getElementById('description-modal').innerText = produit.description_produit;
            document.getElementById('prix').innerText = produit.prix_de_vente + "FCFA";
        }
    </script>
    <!-- Ion Range Slider-->
